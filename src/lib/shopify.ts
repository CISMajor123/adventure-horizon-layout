...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'adventure-horizon-layout-wc83q.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '5a37b214418a21c3955963fd21f82494';
...
export async function storefrontApiRequest(query: string, variables: any = {}) {
  ...
  if (response.status === 402) {
    throw new Error("Shopify API access requires an active billing plan. Please upgrade your Shopify subscription.");
  }
