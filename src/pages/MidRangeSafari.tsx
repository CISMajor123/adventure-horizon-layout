    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[70vh] md:h-screen w-full flex flex-col items-center justify-center pt-24 md:pt-32">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="font-playfair text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
            Mid-Range Safari
          </h1>
        </div>
      ...
      <section 
        id="experiences"
        className="bg-white pt-12 md:pt-20 pb-6 md:pb-10"
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex items-center min-h-[80px] md:min-h-[120px]">
          <h2 className="font-playfair text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#3d2418]">
            Experiences
          </h2>
        </div>
      </section>
              ...
              <div className="relative w-full overflow-hidden h-48 md:h-64 lg:h-80">
                ...
                <AccordionTrigger className="relative z-10 h-full flex items-center justify-start px-4 md:px-8 lg:px-16 hover:no-underline [&[data-state=open]>svg]:rotate-180">
                  <div className="flex items-center w-full">
                    ...
                    <h3 className="font-playfair text-white text-base sm:text-lg md:text-2xl lg:text-3xl font-semibold drop-shadow-lg text-left whitespace-pre-line">
                      {experience.title}
                    </h3>
                  </div>
                </AccordionTrigger>
